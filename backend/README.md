...
## Project Structure
    ...
    ├── test_test_test_test_tcu_1  # Django project configurations
...
1. Clone this repo and `cd test_test_test_test_tcu_1`
...
2. Clone this repo and `cd test_test_test_test_tcu_1`
