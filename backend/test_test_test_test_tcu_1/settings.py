"""
Django settings for test_test_test_test_tcu_1 project.
...
ROOT_URLCONF = 'test_test_test_test_tcu_1.urls'
...
WSGI_APPLICATION = 'test_test_test_test_tcu_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_test_test_test_tcu_1 API",
    "DESCRIPTION": "API documentation for test_test_test_test_tcu_1 App",
    "VERSION": "v1",
}
